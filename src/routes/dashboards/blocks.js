...
export default class extends Component {
  ...
  componentWillMount() {
    axios.get(`http://testnet.ledgerium.net:9999/block/${this.props.match.params.block}`)
      .then(response => {
        if (response.data.number === 0) return;
        this.setState({
          block: response.data,
          loading: false
        })
                ...
                <CardBody>
                  ...
                  <Table>
                    <tbody>
                      ...
                      <tr><td>Parent Hash</td><td><a href={'/app/dashboards/blockexplorer/block/'+(block.number-1)}>{block.parentHash}</a></td></tr>
